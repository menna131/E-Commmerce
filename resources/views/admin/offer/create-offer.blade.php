...
<div class="col-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">{{ __('message.New Offer') }}</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      <form method="post" action="{{ route('store.offer') }}" enctype="multipart/form-data">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" name="title_en"  value="{{ old('title_en') }}"class="form-control" id="exampleInputEmail1" placeholder="Enter offer english name">
          </div>
          @error('title_en')
              ...
              <div class="form-group">
                ...
                <input type="text" name="title_ar"  value="{{ old('title_ar') }}"class="form-control" id="exampleInputEmail1" placeholder="Enter Product arabic name">
              </div>
              @error('title_ar')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
          <div class="form-group">
            ...
            <input type="text" name="discount" value="{{ old('discount') }}" class="form-control" id="exampleInputEmail1" placeholder="Enter discount ">
          </div>
          @error('discount')
                <span class="text-danger">{{ $message }}</span>
              @enderror
