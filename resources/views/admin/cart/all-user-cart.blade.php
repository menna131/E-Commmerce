        ...
        <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $user_cart->email }}</td>
                    <td>{{ $user_cart->phone }}</td>
                    {{-- <td>{{ $user_cart->message }}</td> --}}
                    {{-- <td>
                    ...
                    <td>
                        ...
                        <div style="display: flex;  flex-direction: row; flex-wrap: nowrap; justify-content: space-around;" >
                            <a href="{{ route('show.cart',$user_cart->id) }}" class="btn btn-success">{{ __('message.Show Cart') }}</a>
